...
- [] Configure the blog author in Docusaurus using the `authors.yml` file and ensure each blog post (/home/andrew/Code/andrew-seaford.co.uk/blog) and tutorials (/home/andrew/Code/andrew-seaford.co.uk/docs) references an author. 
- [] Add tags/keywords to blog posts.
- [] Write a markdown file in the folder `/home/andrew/Code/andrew-seaford.co.uk/experiments` that documents the changes.
