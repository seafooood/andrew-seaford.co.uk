...
categories: 
  - "prog"
  - "python"
slug: "how-to-access-sqlite3-database-using-python"
---
...
The class database\_extensions\_tests contains a set of unit tests that will test the database\_extensions functionality. The unit tests create a temporary database and populate the database with a table called settings.
